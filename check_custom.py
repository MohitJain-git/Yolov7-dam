...
def check(list_info):
    ...
    classes_list = [ 'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 'truck', 'boat', 'traffic light',
         ...
         'hair drier', 'toothbrush', "kurta", "nehru jacket", "knitwear", "turban", "scarf", "waist coat", "pajama", "slipper", "shoe", "jodhpuri suit" ]
    ...
    return [person_list,attribute_list]
